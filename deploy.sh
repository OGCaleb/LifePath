...
echo "Building the Flutter web app with base href /LifePath/..."
flutter build web --release --base-href="/LifePath/" #change '/myappRepo/' to the name of the github repo of your project
...
echo "Deployment complete! Visit: https://ogcaleb.github.io/LifePath/" #change to your username in the link